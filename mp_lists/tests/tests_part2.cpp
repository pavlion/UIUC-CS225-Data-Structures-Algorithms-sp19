...
TEST_CASE("List::reverse2", "[weight=10][part=2][valgrind]") {
	List<int> list;

	for (unsigned i = 1; i < 5; i++) { list.insertBack(i); }
	list.print();cout<<endl;
	cout<<"Reverse int case"<<endl;	
	list.reverse();
	list.print();
	cout<<endl<<endl;
...
TEST_CASE("List::reverseNth", "[weight=5][part=2][valgrind]") {
	List<int> list;

	for (unsigned i = 1; i < 5; i++) { list.insertBack(i); }
	list.print();cout<<endl;
	cout<<"ReverseNth int case"<<endl;	
	list.reverseNth(1);
	list.print();
	list.reverseNth(0);
	list.print();
...
TEST_CASE("List::merge2", "[weight=10][part=2][valgrind]") {
	List<int> list1;
	List<int> list2;
