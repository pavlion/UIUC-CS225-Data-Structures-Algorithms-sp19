/**
 * @file main.cpp
 * Contains code for testing the AVLTree class.
 */
...
void testManyRemovals()
{
    ...
    tree.insert( 1, "data for 1");
    tree.insert(71, "data for 71");
    tree.insert(82, "data for 82");cout<<endl;
    tree.remove(95);cout<<"remove 95"<<endl;tree.print();
    tree.remove(94);cout<<endl<<"remove 94"<<endl;tree.print();
    tree.remove(61);cout<<endl<<"remove 61"<<endl;tree.print();
    tree.remove(76);cout<<endl<<"remove 76"<<endl;tree.print();
    tree.remove(73);cout<<endl<<"remove 73"<<endl;tree.print();
    tree.remove(71);cout<<endl<<"remove 71"<<endl;
    tree.print();
    printEnd();
}
