...
class AVLTree
{
  ...
  private:
	...
	/**
     * Helper function to find the balance factor of a given subtree.
     * @param node The current node.
     */
	int findBalanceFactor(Node*& subtree);
	...
	/**
     * Helper function to update the height of each node
     * @param subtree: The current node to be dealt with.
     */
	int updateHeight(Node* subtree);
	
	/**
     * Helper function to find the IOP when deleting
     * @param subtree: The current node to be dealt with.
     */
	Node* findIOP(Node*& n, Node*& IOPParent);
