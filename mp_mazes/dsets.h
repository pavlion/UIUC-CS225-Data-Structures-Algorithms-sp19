 ...
 * It should be implemented with the optimizations discussed in lecture, 
 * as up-trees stored in a single vector of ints. 
 * Specifically, use path compression and union-by-size. 
 * Each element of the vector represents a node. 
